...
//   return (
//     <section className="py-20 bg-gradient-to-b from-violet-50/50 to-background overflow-hidden">
...
//           >
//             <div className="aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl border-2 border-border shadow-card" />
//           </motion.div>
...
//             <Button size="lg" className="bg-[#72339F] text-white border border-[#72339F] hover:bg-[#6a2f93] hover:border-[#6a2f93] px-8 py-6 text-base group shadow-lg hover:shadow-xl transition-all">
//               EXPLORE NOW
